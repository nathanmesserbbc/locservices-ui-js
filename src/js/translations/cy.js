define(function() {
  ...
  var dictionary = {
    ...
    'user_locations.action.label.prefer': 'Make {name} your main location',
    'user_locations.action.label.remove': 'Remove {name} as your main location',
    'user_locations.action.label.delete': 'Remove {name} from other locations',
